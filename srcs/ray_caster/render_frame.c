...
/*   Updated: 2024/09/06 11:41:28 by ade-sarr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_ray_colored(t_cub3d *c, t_raycast *r, bool vertical_wall,
						int wallitem)
{
	double	p_wall_dist;
	int		height;
...
void	cast_ray(t_cub3d *c, t_raycast *r, t_point mapc)
{
	...
	render_ray_colored(c, r, vertical_wall, mapitem);
}
